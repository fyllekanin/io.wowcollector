...
public class MountCollectionViewSeeder implements Seeder {
    @Override
    public String getName() {
        return "mount-collection-views-seed";
    }
    ...
    private List<MountCollectionViewDocument> getData() {
        try {
            Type listType = new TypeToken<ArrayList<MountCollectionViewDocument>>() {
            }.getType();
            InputStream inputStream = Thread.currentThread()
                    .getContextClassLoader()
                    .getResourceAsStream("seeds/mount-collection-views.json");
